...
export class Initial1765028940520 implements MigrationInterface {
    name = 'Initial1765028940520'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sessions" ("key" uuid NOT NULL DEFAULT uuid_generate_v4(), "token" text NOT NULL, "expires_at" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_89dfa37848e4d268927ac5e875e" PRIMARY KEY ("key"))`);
