      ...
      <div className="h-full flex">
        <div className="h-full py-16 w-[28rem] bg-gray-300 dark:bg-gray-800 transition-colors">
          <div className="ml-auto w-48">
            {tabs.map(tab => (
              <Link
                ...
                className={classNames(
                  'block first:mt-0 mt-1 w-full px-4 py-2 text-sm rounded-l-md transition-colors',
            ...
            <button
              type="button"
              className="flex justify-between w-full px-4 py-2 text-sm rounded-l-md transition-colors hover:bg-gray-200 dark:hover:bg-gray-700"
              onClick={logout}
            >
              <p>Log out</p>
