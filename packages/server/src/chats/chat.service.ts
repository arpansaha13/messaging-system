...
export class ChatService {
  ...
  #sameParticipantError() {
    throw new BadRequestException(
      'Both chat participants cannot have the same user_id.',
    )
  }
  ...
  updateMsgStatus(
    msgId: number,
    newStatus: MessageStatus.DELIVERED | MessageStatus.READ,
  ) {
